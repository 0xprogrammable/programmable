...
export function GET() {
  ...
  const content = [
    ...
    `For a project with multiple contract roles, also read ${entry.workflows.multiRoleProject.capabilities} and ${entry.workflows.multiRoleProject.guide}. Published guides are not proof that admission is enabled; use the live readiness and documented request packer.`,
    "## Contribute a module",
