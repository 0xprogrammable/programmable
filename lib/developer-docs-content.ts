...
export function buildProgrammableLlmsIndex(): string {
  return [
    ...
    "- [Module contributions](https://programmable.market/developers/module-mode-api-v1.md): build Native or executable Engine source, compile general/fixed configuration, submit and track review with the pinned development.5 CLI. The [Engine starter manifest](https://programmable.market/developers/module-mode-starters/engine-program/v0.1.0-development.1/manifest.json) identifies an unreviewed source download.",
