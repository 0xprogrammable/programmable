...
export function buildProgrammableLlmsIndex(): string {
  return [
    ...
    "- [Module contributions](https://programmable.market/developers/module-mode-api-v1.md): read your key-bound author and prerequisites before building, submit open source packages, and track independent review with the current pinned CLI. The [Engine starter manifest](https://programmable.market/developers/module-mode-starters/engine-program/v0.1.0-development.1/manifest.json) identifies an unreviewed source download.",
