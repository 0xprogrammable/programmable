...
// Keep the historical 4.0 setup bytes stable; active discovery uses the Native20 instructions.
...
export const PROGRAMMABLE_ROBINHOOD_FUNDING_INTAKE_V1 = Object.freeze({
  ...
  instructions: Object.freeze([
    ...
    ROBINHOOD_NATIVE20_FEE_INSTRUCTIONS,
...
export function buildProgrammableAgentSetupTextV1(profileVersion = "4.0.0") {
  ...
  return [
    ...
    successor ? PROGRAMMABLE_ROBINHOOD_FUNDING_INTAKE_TEXT_V1
      : PROGRAMMABLE_ROBINHOOD_FUNDING_INTAKE_TEXT_V1.replace(ROBINHOOD_NATIVE20_FEE_INSTRUCTIONS, ROBINHOOD_HISTORICAL_FEE_INSTRUCTIONS),
    "",
