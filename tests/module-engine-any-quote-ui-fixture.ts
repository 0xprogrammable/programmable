...
import { computeModuleEngineHostManifestHash, computeModuleEngineReleaseDigest, moduleEngineReleaseIdentity, type ModuleEngineAnyQuoteReleaseIdentity, type ModuleEngineRelease } from "@/lib/module-engine/catalog";
import { MODULE_ENGINE_ANY_QUOTE_ECONOMICS_POLICY_ID, MODULE_ENGINE_ANY_QUOTE_PROFILE, MODULE_ENGINE_ANY_QUOTE_SOURCE_VERSION } from "@/lib/module-engine/profile";
...
export function anyQuoteUiFixture() {
  const f = fixture();
