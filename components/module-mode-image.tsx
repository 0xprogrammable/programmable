    ...
    <div className={styles.imageField}>
      ...
      <div className={styles.imagePicker}>
        ...
        <div className={styles.imagePickerContent}>
          ...
          <p id="module-token-image-status" className={styles.help} role="status">{preparing ? "Preparing image…" : image.kind === "local" ? "Prepared on your device. It has not been uploaded." : image.kind === "uri" ? "Using a public image link. Its contents are not verified yet." : ""}</p>
        </div>
      </div>
