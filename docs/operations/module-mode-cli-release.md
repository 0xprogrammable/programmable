...
module_cli_base='https://programmable.market/developers/module-mode-cli/v1.0.0-development.4'
curl --fail --proto '=https' --tlsv1.2 --output programmable-module-mode-1.0.0-development.4.mjs "$module_cli_base/programmable-module-mode-1.0.0-development.4.mjs"
...
node programmable-module-mode-1.0.0-development.4.mjs --version
node programmable-module-mode-1.0.0-development.4.mjs --help
```
